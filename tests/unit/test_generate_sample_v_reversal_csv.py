...
SCRIPT_PATH = PROJECT_ROOT / "scripts" / "generate_sample_v_reversal_csv.py"
OUTPUT_PATH = PROJECT_ROOT / "data" / "raw" / "sample_v_reversal.csv"
...
def test_output_csv_contains_close_column(script_result: subprocess.CompletedProcess[str]) -> None:
